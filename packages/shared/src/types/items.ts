...
/** Прок «шанс каста» (D2 chance-to-cast): с шансом `chance` кастуется скилл `skillId` уровня `level`.
 *  `trigger`: 'hit' — когда сам бьёшь (наносишь урон); 'struck' — когда бьют тебя (получаешь урон). */
