/**
 * Резолверы метаданных типов урона (имя/цвет/подпись) — из ЖИВОГО конфига
 * `damage-types` (data-driven). App заполняет при старте; до этого — фолбэки.
 * Единый источник для всплывающих чисел, иконок, тултипов (без хардкода/задвоений).
 */
